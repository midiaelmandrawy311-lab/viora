...
const defaultPrompt = `A cinematic 5-second animated intro for a professional gamer named “SNAKE”, inspired by Roblox. The character wears a green hoodie with black details. The background is fiery and dynamic, with glowing effects, sparks, and smooth camera motion. The logo “SNAKE” appears in bold green neon letters with a metallic shine and energy waves. The atmosphere feels intense and futuristic — perfect for a YouTube gaming channel intro. Resolution 2160x1080 (YouTube size), widescreen format.`;

const defaultInitialValues: GenerateVideoParams = {
...
const App: React.FC = () => {
  ...
  const handleNewVideo = useCallback(() => {
    ...
    setInitialFormValues(defaultInitialValues); // Reset to default form state
  }, []);
          ...
          <>
            <div className="flex-grow flex items-center justify-center">
              <div className="relative text-center">
                <h2 className="text-3xl text-gray-600 px-4">
                  Start with our example prompt below
                </h2>
